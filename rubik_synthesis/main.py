...
colors_csv = pd.read_csv("rubik_synthesis/textures/colors.csv", index_col="face")

list = []

for index, values in colors_csv.iterrows():
    list.append(values.to_numpy().reshape(3, 3))
